  ...
  #          st.write("Cannot parse SMILES string!")
        ...
        if option == "PaDEL":
            ...
            with st.spinner('CALCULATING PREDICTIONS (STEP 5 OF 5)...'):
                ...
                st.caption("Sources: -L = Biomacromolecules 2019, 20, 8, 3041–3056; -H = Biomacromolecules 2018, 19, 7, 3119–3128; -M = in-house data; Px, Py and P1-P8 = Sci. Adv. 2019, 5, eaav9784; no suffix = https://doi.org/10.26434/chemrxiv-2022-s8xc3")
                #st.dataframe(df)
                st.image(im)
