...
with st.form(key='my_form_to_submit'):
    with st.expander("More information"):
        ...
        A formulation report is generated, outputting predictions for all models, given a polymer feed of 10 g/L and drug feeds of 2-10 g/L.""")
        
        st.caption("""Model choice""")
