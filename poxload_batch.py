...
os.system("rm db_library_merged.sdf xgb*.rda startdatayyy*.dat db_molstest.csv descriptors_padel_pol.csv descriptors_padeltest.csv formulations3test_db.csv librarytest.sdf mixture_test.txt setup.txt sirms_test.txt descp.csv smiles3.csv")
sys.exit()
